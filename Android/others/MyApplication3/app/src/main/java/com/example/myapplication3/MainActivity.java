...
//        Entry entry = new Entry(1, 1); // create a point
//        mLineData.addEntry(entry, 0); // Add entry to the polyline at the specified index
...
//        MainActivity myMarkView = new MainActivity();
//        myMarkView.setChartView(mLineChart);
//        mLineChart.setMarker(myMarkView);
    ...
    void initLine() {
        ...
        createLine(mList1, mEntries1, mLineDataSet1, 0xffff0000, mLineData, mLineChart);
        createLine(mList2, mEntries2, mLineDataSet2, 0xff00ff00, mLineData, mLineChart);
        createLine(mList3, mEntries3, mLineDataSet3, 0xff0000ff, mLineData, mLineChart);
...
//        mv.setMarkerView(lineChart);
//        lineChart.setMarker((IMarker) mv);
//        lineChart.invalidate();
//    }
