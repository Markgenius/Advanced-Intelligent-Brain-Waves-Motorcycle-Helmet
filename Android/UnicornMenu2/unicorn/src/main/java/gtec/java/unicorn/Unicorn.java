...
public class Unicorn {
    ...
    public final static int SamplingRateInHz = 250/128;   //250   250/128    1
    ...
    private final static int BufferSizeInSeconds = 10;  //10
    private final static byte TotalPayloadLengthInBytes = 45;//45
